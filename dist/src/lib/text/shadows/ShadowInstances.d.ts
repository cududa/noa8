...
export class ShadowInstances {
     ...
     */
    forEach(callback: (value: ShadowData, key: number, map: Map<number, ShadowData>) => void): void;
}
export type ShadowData = {
    /**
     * - Reference to text handle
     */
    textHandle: object;
    /**
    ...
    depth: number;
    /**
     * - X offset from mesh origin
     */
    centerOffsetX: number;
    /**
     * - Z offset from mesh origin
     */
